...
export const KeyLinks = ({ rsvp = true, schedule = true, venue = true, faqs = true }: { rsvp?: boolean, schedule?: boolean, venue?: boolean, faqs?: boolean,  }) => {
    const allTrue = rsvp && schedule && venue && faqs
    return (
