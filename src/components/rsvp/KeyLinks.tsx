...
export const KeyLinks = ({ rsvp = true, schedule = true, venue = true, faqs = true, addContainer = true }: { rsvp?: boolean, schedule?: boolean, venue?: boolean, faqs?: boolean, addContainer?: boolean }) => {
    const allTrue = addContainer || rsvp && schedule && venue && faqs
    return (
